...
SRCS        = 	main.c signals.c tokenizer.c \
				lexer.c lexer_syntax.c heredoc_loop.c heredoc_xpander.c \
				utils_close_n_free.c utils.c utils_init_data.c utils_lexer.c utils_parser.c \
